from constants import API_BASE_URL_1, API_BASE_URL_2, API_BASE_URL_3, HEADER_X_APP_ID, HEADER_X_APP_KEY, HEADER_X_DEVICE_ID, HEADER_X_DEVICE_PLATFORM, \
...
def generateOTP(sid, rmn):
    ...
    print("\n \n \n")
    otp_with_rmn_url = API_BASE_URL_2 + "rest-api/pub/api/v1/rmn/" + rmn + "/otp"
...
def lookupSid(rmn):
    url = API_BASE_URL_2 + "rest-api/pub/api/v1/subscriberLookup" + "?rmn=" + rmn
